        ...
        if not player_row:
            ...
            if player_row:
                ...
                return {
                    "type": 4,
                    "data": {
                        "content": f"Hey {username}! Your score wasn't recorded because you're not in this league yet. Ask the league manager to add you at {os.environ.get('APP_DOMAIN', 'app.wordplayleague.com')} 👋",
                        "flags": 64
                    }
                }
