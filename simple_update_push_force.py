...
def push_to_github():
    ...
    try:
        ...
        # This is the key change - we're adding a timestamp file to force Git to detect changes
        ...
        subprocess.run(["git", "add", "last_update.txt"], cwd=export_dir, capture_output=True, text=True)
